  ...
  return (
    <div style={appStyle}>
      ...
      <div className={`cardContainer ${cardVisible ? 'show' : ''}`}>
          ...
          <CardContent>
            ...
            <div className="optionsContainer">
              <label className="option">
                <input type="radio" value="1. RERA" checked={selectedOption === '1. RERA'} onChange={handleOptionChange} />
                RERA
              </label>
              <br></br>
              <label className="option">
                <input type="radio" value="2. NABARD" checked={selectedOption === '2. NABARD'} onChange={handleOptionChange} />
                NABARD
              </label>
              <br></br>
              <label className="option">
                <input type="radio" value="3. IRDA" checked={selectedOption === '3. IRDA'} onChange={handleOptionChange} />
                IRDA
              </label>
              <br></br>
              <label className="option">
                <input type="radio" value="4. SEBI" checked={selectedOption === '4. SEBI'} onChange={handleOptionChange} />
                SEBI
              </label>
              <br></br>
            </div>
        ...
        <br></br>
        <button onClick={()=>navigate('/quiz9')}>Next Question</button>
